...
### 输出接口（使用示例）
```python
from sage.llm.engines.sagellm.accel.sparsity import SparsityManager, SparsityConfig
...
from sage.llm.engines.sagellm.accel.kernel_fusion import FusedSparseAttention
