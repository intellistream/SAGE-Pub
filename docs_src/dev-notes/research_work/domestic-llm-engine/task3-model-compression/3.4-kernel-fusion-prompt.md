...
### 输出接口（使用示例）
```python
from sagellm.accel.kernel_fusion import KernelFusionManager, KernelFusionConfig
...
from sagellm.accel.quantization import QuantizationManager
from sagellm.accel.kernel_fusion import KernelFusionManager
...
```python
# 稀疏权重 + FFN 融合
from sagellm.accel.sparsity import SparsityManager
...
from sagellm.kvmgr.kv_pool import KVPool
