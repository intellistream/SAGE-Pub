...
### 输出接口（使用示例）
```python
from sage.llm.sagellm.accel.kernel_fusion import KernelFusionManager, KernelFusionConfig
...
from sage.llm.sagellm.accel.quantization import QuantizationManager
from sage.llm.sagellm.accel.kernel_fusion import KernelFusionManager
...
```python
# 稀疏权重 + FFN 融合
from sage.llm.sagellm.accel.sparsity import SparsityManager
