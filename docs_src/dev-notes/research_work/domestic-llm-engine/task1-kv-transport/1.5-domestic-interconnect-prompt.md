...
from sage.llm.sagellm.comm_backend.collective_ops import CommBackendProtocol
...
### 使用示例
```python
from sage.llm.sagellm.comm_backend.domestic import create_domestic_backend
...
# 也可以通过统一接口使用
from sage.llm.sagellm.comm_backend.collective_ops import create_comm_backend
