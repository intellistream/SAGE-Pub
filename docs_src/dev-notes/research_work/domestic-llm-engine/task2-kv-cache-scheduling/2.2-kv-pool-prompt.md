...
### 输入接口
```python
from sage.llm.sagellm.kv_runtime.kv_pool import KVPoolProtocol, BlockAllocationRequest
...
```python
    def migrate_blocks(
        ...
        4. 释放源节点 Blocks
        """
        from sage.llm.sagellm.comm_backend.kv_transfer import KVTransferProtocol
...
from sage.llm.sagellm.kv_runtime.kv_pool import GPUKVPool, BlockAllocationRequest
