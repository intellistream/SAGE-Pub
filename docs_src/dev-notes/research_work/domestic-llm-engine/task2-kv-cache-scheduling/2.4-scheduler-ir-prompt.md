...
### 输入接口
```python
from sage.llm.sagellm.scheduler_ir import (
...
class MemoryAwarePreemptionPass(OptimizationPass):
    ...
    def apply(
        ...
        if required_memory > available_memory:
            ...
            # 调用驱逐策略选择受害者
            from sage.llm.sagellm.kv_policy.eviction import EvictionCandidate
            candidates = [
                EvictionCandidate(
...
from sage.llm.sagellm.scheduler_ir import BaseSchedulerIR, ScheduleRequest
...
class LMDeployScheduler:
    def __init__(self, prefix_cache, kv_pool):
        ...
        # 添加优化 Passes
        from sage.llm.sagellm.scheduler_ir.passes import (
