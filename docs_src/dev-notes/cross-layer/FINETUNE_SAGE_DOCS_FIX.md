...
1. ✅ `packages/sage-studio/src/sage/studio/frontend/src/components/FinetunePanel.tsx`
...
1. **打开 Finetune 面板**
1. **选择数据源**: 点击 "📚 使用 SAGE 官方文档"
1. **等待准备**:
   - 显示加载提示："正在下载 SAGE 文档并准备训练数据..."
   - 首次下载需要 1-3 分钟
1. **查看成功提示**: "✅ SAGE 文档已准备完成！共 XXX 条训练数据"
1. **查看文件名**: 显示 "✅ 数据已准备: sage_docs_finetune_data.json"
1. **继续微调**: 选择模型和参数，点击"开始微调"
