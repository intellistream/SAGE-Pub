...
用户指南按照 SAGE 的 **L1-L6 分层架构**组织，帮助您从底层基础设施到上层应用全面了解系统。
...
**核心功能**：
- 📬 **队列抽象** - Python Queue, Ray Queue, RPC Queue
- 💾 **存储抽象** - Key-Value 存储后端
- 🔌 **服务基类** - 统一的服务接口
...
#### [sage-studio 可视化](packages/sage-studio/index.md)

Web 界面管理工具，提供可视化的系统管理能力。

� [查看文档](packages/sage-studio/index.md)
...
**实现 RAG 系统**  
→ 学习 [L3: Libs - RAG](packages/sage-libs/rag.md) + [L4: Middleware - NeuroMem](packages/sage-middleware/components/neuromem.md)

**高性能需求**  
→ 学习 [L4: Middleware](packages/sage-middleware/overview.md) + [GPU 加速](packages/sage-middleware/hardware/gpu_acceleration.md)
...
-   :material-engine-outline:{ .lg .middle } __L3: 核心层__
    ...
    [:octicons-arrow-right-24: Kernel](packages/sage-kernel/README.md) | [:octicons-arrow-right-24: Libs](packages/sage-libs/README.md)
...
-   :material-application-outline:{ .lg .middle } __L5: 应用层__

    ---

    完整应用和示例项目

    [:octicons-arrow-right-24: Apps](packages/sage-apps/index.md) | [:octicons-arrow-right-24: 示例](applications.md)

-   :material-monitor-dashboard:{ .lg .middle } __L6: 接口层__
