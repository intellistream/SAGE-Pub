...
- **Name:** docs-public
- **Repository:** https://github.com/intellistream/SAGE-Pub.git
- **Branch:** main-dev
- **Path:** `docs-public`
...
git add docs-public
git commit -m "chore: update SAGE-Pub submodule reference"
git push origin main-dev
```
...
cd ../
git add docs-public
git commit -m "chore: update SAGE-Pub to latest"
```
...
git add docs-public
git commit -m "chore: update SAGE-Pub reference"
```
